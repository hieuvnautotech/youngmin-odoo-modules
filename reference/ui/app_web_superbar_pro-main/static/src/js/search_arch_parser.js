    ...
    visitSearchPanel(searchPanelNode) {
        ...
        for (const node of searchPanelNode.children) {
            ...
            if (type === "category") {
                ...
                section.current = attrs.current || "0";
                // Add domain
                section.domain = attrs.domain || "[]";
                section.follow = attrs.follow || "0";
                section.searchType = attrs.type || "0";
                section.dateValue = {},
                section.context = makeContext([ section.context,attrs.context ]) || {};
                section.hierarchize = evaluateBooleanExpr(attrs.hierarchize || "0");
