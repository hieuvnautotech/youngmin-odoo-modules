...
import { CMMSKanbanDynamicRecordList } from "./cmms_kanban_dynamic_list";
import { RelationalModel } from "@web/model/relational_model/relational_model";
import { Record } from "@web/model/relational_model/record";

export class CMMSKanbanRecord extends Record {
    /**
...
export class CMMSKanbanModel extends RelationalModel {
    static Record = CMMSKanbanRecord;
    static DynamicRecordList = CMMSKanbanDynamicRecordList;
    /*
    ...
    */
    ...
    //override load change domain
    // async load(params = {}) {

    //     //web_search_read
      
    //      var json_domain = localStorage.getItem("cmms_domain")
    //      var is_from_record = localStorage.getItem('cmms_record_click')
    //      if (json_domain && is_from_record) {
    //             let domain= JSON.parse(json_domain)
    //           //  params.domain = domain
               
    //             localStorage.removeItem('cmms_record_click')
    //      }
