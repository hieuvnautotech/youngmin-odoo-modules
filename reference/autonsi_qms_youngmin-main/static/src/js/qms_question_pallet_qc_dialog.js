...
class QMSQuestionPalletQCDialog extends Component {
    static template = "qms_question_pallet_qc_dialog_template";
    ...
    setup() {
        ...
        this.state = useState({
            ...
            'picking_wizard_id': context.picking_wizard_id,
    ...
    async saveData() {
        // try {
            ...
            await this.orm.call('mes.qc_form.history', 'create_history_pallet_qc', [], {inspectionData: this.state});
...
function mesQcPreviewPalletQCAction(env, action) {
    const dialog = env.services.dialog;

    dialog.add(QMSQuestionPalletQCDialog , {
        context: action.context,
    });
}


actionRegistry.add("qms_question_pallet_qc_action", mesQcPreviewPalletQCAction);