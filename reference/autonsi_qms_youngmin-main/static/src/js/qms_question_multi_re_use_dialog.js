...
class QMSQuestionMultiREUSEDialog extends Component {
    static template = "qms_question_multi_re_use_dialog";
    ...
    setup() {
        ...
        this.state = useState({
            ...
            'stock_quant_ids': context.stock_quant_ids,
    ...
    async saveData() {
        // try {
            ...
            await this.orm.call('mes.qc_form.history', 'create_history_multi_re_use', [], {inspectionData: this.state});
...
function mesQcPreviewMultiREUSEAction(env, action) {
    const dialog = env.services.dialog;

    dialog.add(QMSQuestionMultiREUSEDialog, {
        context: action.context,
    });
}


actionRegistry.add("qms_question_multi_re_use_action", mesQcPreviewMultiREUSEAction);